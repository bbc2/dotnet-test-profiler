...
[ -z "${CORECLR_PATH:-}" ] && CORECLR_PATH=~/ext/coreclr
...
clang++ -g -shared -o $Output $CXX_FLAGS $INCLUDES ClassFactory.cpp CorProfiler.cpp dllmain.cpp asmhelpers/amd64/systemv/asmhelpers.S
